...
PISTOMP_ENABLED=bool(int(os.environ.get('PISTOMP_ENABLED', True)))
PISTOMP_APT_PACKAGE=os.environ.get('PISTOMP_APT_PACKAGE', 'mod-ui')
PISTOMP_UPDATE_CHECK_URL=os.environ.get('PISTOMP_UPDATE_CHECK_URL', 'https://micahvdm.github.io/pi-stomp-apt')
